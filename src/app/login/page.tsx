...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#fcfcfd] flex items-center justify-center p-6 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-[440px] relative z-10 space-y-8 animate-in fade-in zoom-in-95 duration-1000">
                {/* Logo & Header */}
                <div className="text-center space-y-6">
                    <div className="flex flex-col items-center justify-center space-y-4">
                        <div className="relative w-28 h-28 drop-shadow-2xl animate-in slide-in-from-bottom-4 duration-1000">
                            <Image
                                src="/logoFYA.png"
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[#e31b23] font-bold text-[10px] uppercase tracking-[0.4em]">
                ...
                {/* Login Card */}
                <div className="bg-white/70 border border-white/40 backdrop-blur-2xl p-10 rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] relative overflow-hidden group">
                    <div className="absolute top-0 left-0 w-full h-1.5 bg-[#e31b23]" />

                    <form action={handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-[#666] uppercase tracking-widest pl-1">
                                    Nombre de Usuario
                                </label>
                        ...
                        {error && (
                            <div className="bg-red-50 border border-red-100 text-[#e31b23] text-xs font-bold p-4 rounded-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-1">
                        ...
                        <button
                            disabled={loading}
                            className="w-full h-14 bg-[#1a1a1a] text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-[#e31b23] hover:shadow-2xl hover:shadow-[#e31b23]/20 transition-all active:scale-[0.98] disabled:opacity-50 group shadow-lg"
                        >
                            {loading ? (
